...
{
    public class InicioConfig : SectionConfigBase<LocalStorageDataConfig, HtmlSchema>
    {
        ...
        public override LocalStorageDataConfig Config
        {
            get
            {
                ...
                {
                    FilePath = "/Assets/Data/Inicio.htm"
                };
            }
        }
        ...
        public override NavigationInfo ListNavigationInfo
        {
            get 
            {
                return NavigationInfo.FromPage("InicioListPage");
            }
        }
