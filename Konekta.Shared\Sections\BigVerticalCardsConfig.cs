    ...
    public class BigVerticalCardsConfig : SectionConfigBase<DynamicStorageDataConfig, BigVerticalCards1Schema>
    {
        ...
        public override DynamicStorageDataConfig Config
        {
            get
            {
                ...
                {
                    Url = new Uri("http://ds.winappstudio.com/api/data/collection?dataRowListId=ced43f53-2333-45d5-a819-dd0a95a45e32&appId=b0730124-f888-45f1-86d6-45253b6f7f44"),
