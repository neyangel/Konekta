...
using Konekta.Services;

#if WINDOWS_APP
using Windows.System;
using Windows.UI.Core;
using Windows.UI.ApplicationSettings;
using Konekta.AppFlyouts;
#endif
...
namespace Konekta
{
    ...
    {
        private Guid APP_ID = new Guid("b0730124-f888-45f1-86d6-45253b6f7f44");
        public const string APP_NAME = "Konekta";
        ...
        private void UpdateAppTiles()
        {
            ...
            if (init == null || (init is bool && !(bool)init))
            {
                ...
                tiles.Add("bde8a83e845607d8", "DataImages/Tile1.jpg");
                tiles.Add("bde8a83e845607d9", "DataImages/Tile2.jpg");
                tiles.Add("bde8a83e845607da", "DataImages/Tile3.jpg");
                tiles.Add("bde8a83e845607db", "DataImages/Tile4.jpg");
                tiles.Add("bde8a83e845607dc", "DataImages/Tile5.jpg");
