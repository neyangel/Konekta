    ...
    public class HorizontalCardsConfig : SectionConfigBase<DynamicStorageDataConfig, HorizontalCards1Schema>
    {
        ...
        public override DynamicStorageDataConfig Config
        {
            get
            {
                ...
                {
                    Url = new Uri("http://ds.winappstudio.com/api/data/collection?dataRowListId=2301142f-87c9-43d5-b0dc-5cb4a0a0f8b4&appId=b0730124-f888-45f1-86d6-45253b6f7f44"),
