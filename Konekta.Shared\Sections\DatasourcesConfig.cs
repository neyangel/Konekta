...
{
    public class DatasourcesConfig : SectionConfigBase<LocalStorageDataConfig, MenuSchema>
    {
        ...
        public override LocalStorageDataConfig Config
        {
            get
            {
                ...
                {
                    FilePath = "/Assets/Data/Datasources.json"
                };
            }
        }
        ...
        public override NavigationInfo ListNavigationInfo
        {
            get 
            {
                return NavigationInfo.FromPage("DatasourcesListPage");
            }
        }
