    ...
    public class PhotoLayoutConfig : SectionConfigBase<DynamicStorageDataConfig, PhotoLayout1Schema>
    {
        ...
        public override DynamicStorageDataConfig Config
        {
            get
            {
                ...
                {
                    Url = new Uri("http://ds.winappstudio.com/api/data/collection?dataRowListId=ccd467e1-2fd6-4f13-a0fb-6ca261f872ec&appId=b0730124-f888-45f1-86d6-45253b6f7f44"),
