    ...
    public class PhotoLeftConfig : SectionConfigBase<DynamicStorageDataConfig, PhotoLeft1Schema>
    {
        ...
        public override DynamicStorageDataConfig Config
        {
            get
            {
                ...
                {
                    Url = new Uri("http://ds.winappstudio.com/api/data/collection?dataRowListId=0031601e-7f72-4d30-8867-1ba7678a914e&appId=b0730124-f888-45f1-86d6-45253b6f7f44"),
